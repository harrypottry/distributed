package com.test.michael.business.draw.repo.repository;
...
import com.test.michael.business.draw.repo.dao.AwardItemDao;
import com.test.michael.business.draw.repo.dao.AwardPoolDao;
import com.test.michael.business.draw.repo.dao.AwardPrizeDao;
...
import com.test.michael.business.draw.repo.repository.cache.DrawLotteryCacheAccess;
...
public class DrawLotteryRepository {
    ...
    private DrawLottery getDrawLotteryFromDB(int lotteryId){
        ...
        List<AwardPool> awardPools=new ArrayList<AwardPool>();
